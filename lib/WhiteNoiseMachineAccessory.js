...
class WhiteNoiseMachineAccessory extends BaseAccessory {
    ...
    _registerCharacteristics(dps) {
        ...
        // Optional volume on the white noise switch service
        let characteristicVolume;
        if (this.useVolume) {
            characteristicVolume = serviceWhiteNoise.addCharacteristic(Characteristic.Volume)
                .updateValue(dps[this.dpVolume])
